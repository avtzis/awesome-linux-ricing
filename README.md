...
- [vicinae](https://github.com/vicinaehq/vicinae) - Focused launcher for your desktop — native, fast, extensible.
...
- [fetch](https://github.com/areofyl/fetch) - A `neofetch` alternative with a 3D animated distro logo
